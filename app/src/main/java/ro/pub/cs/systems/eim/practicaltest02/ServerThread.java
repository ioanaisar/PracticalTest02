...
public class ServerThread extends Thread {
    ...
    private final HashMap<String, MoneyInfo> data;
  ...
  /*  public synchronized void setData(String city, WeatherForecastInformation weatherForecastInformation) {
    ...
    public synchronized void setData(String city, MoneyInfo weatherForecastInformation) {
        this.data.put(city, weatherForecastInformation);
    }

    public synchronized HashMap<String, MoneyInfo> getData() {
        return data;
    }
